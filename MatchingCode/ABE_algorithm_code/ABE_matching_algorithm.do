...
global datadirA			 "/Users/rachelanderson/Desktop/3rdYrPaper/Code/Simulated_Data"		  		/*location where the raw data for dataset A is held*/
global datadirB			 "/Users/rachelanderson/Desktop/3rdYrPaper/Code/Simulated_Data"  			/*location where the raw data for dataset B is held*/
global outdir 			 "/Users/rachelanderson/Desktop/3rdYrPaper/Code/Output" 						/*location to store cleaned data*/
global matchdir 		 "/Users/rachelanderson/Desktop/3rdYrPaper/Code/Output"			 				/*location to store matched data*/
...
/* 2.2 Find ABE matches, standard version */
	clear
	abematch $match_vars,  file_A($A) file_B($B) timevar(year) timediff($timediff ) save($outputfile )  replace id_A(id) id_B(id) unique_m(2) unique_f(2) keep_A(l_name f_name) keep_B(l_name f_name) 
