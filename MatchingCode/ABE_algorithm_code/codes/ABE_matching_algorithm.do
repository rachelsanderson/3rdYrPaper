...
global MatchingDoFiles   "/Users/hkissel/Dropbox/Replications/ABE_algorithm_code/codes"  	    	/*location where all ABE/Ferrie matching algorithm files (and .ado files) are stored */
