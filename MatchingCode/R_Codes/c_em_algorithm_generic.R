...
#Count number of observations for each possible combination
dataagg<-cbind(c(1:length(Age_Dist)),Age_Dist,Dist_FN, Dist_LN)

dataagg<-aggregate(dataagg[,1], by=list(Age_Dist,Dist_FN, Dist_LN), FUN=length)
