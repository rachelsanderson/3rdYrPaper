...
Hence the optimal estimator $\hat{\mu} = d^* \hat{mu}_1 + (1-d^*) \hat{\mu}_2$ depends on $\sigma^2, \omega^2, \mu,$ and $\kappa$.  To see how these change, Figure below demonstrates. 

\begin{center}
\caption{Par values = ( 1 1 0 1 )}
