...
\begin{tabular}{L{4cm}C{3cm}L{3.5cm}L{8cm}L{12cm}}
\toprule
...
\midrule
Anderson (2019) & GMM & Files A and B, linked via Fellegi-Sunter/EM  & Want to relax the assumption where matching variables are independent of the response variable, or the true link is not included among possible matches. & Compare PII with multiple matches vs. only one match; compare one match with weighted linear sum assignment vs. other 
 \end{tabular}
