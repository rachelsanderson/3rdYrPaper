...
% flesh this out probably. 
Step (iv) is the most complicated step, and so I defer discussion to the next sections.  In total, I implement four matching methods which produce the matched datasets described in Table \ref{overview}.  The rest of this section is devoted to discussing each method in detail.
